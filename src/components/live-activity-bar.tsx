...
export default function LiveActivityBar() {
  return (
    <div className="sticky top-[80px] z-40 w-full overflow-hidden bg-gradient-to-r from-primary to-accent">
      <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-24 bg-gradient-to-r from-primary to-transparent" />
      <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-24 bg-gradient-to-l from-accent to-transparent" />

      <div className="flex animate-marquee-rtl whitespace-nowrap">
        {/* Render items twice for seamless loop */}
        {[...activityItems, ...activityItems].map((item, index) => (
          <div key={index} className="flex shrink-0 items-center gap-2 py-2 px-8 text-primary-foreground">
