      ...
      <div className="container mx-auto px-4 py-16 md:px-6">
        <div className="grid gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              Demo is the heart of the professional community and the best resource to discover and connect with talent and jobs worldwide.
            </p>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm text-muted-foreground">
          <p className="text-center md:text-left mb-4 md:mb-0">
            &copy; {new Date().getFullYear()} Demo. All rights reserved. Developed By <span className="font-semibold text-primary">TGNE Solutions</span> - Tema.
          </p>
